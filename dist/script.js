...
var forms = function forms(state) {
  ...
  Object(_checkNumInput__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); //создаем сообщения
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //создаем блок со статусом отправки

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage); //собираем введенные данные с формы 
